...
export default function Habits() {
 ...
 let sortingHabits = () => {
  sortedHabits === "ascending" ? setSortedHabits(habits.sort((high,low) => low.priority.localeCompare(high.priority))) : sortedHabits === "descending" ? setSortedHabits(habits.sort((high,low) => high.priority.localeCompare(low.priority))) : setSortedHabits(null);
